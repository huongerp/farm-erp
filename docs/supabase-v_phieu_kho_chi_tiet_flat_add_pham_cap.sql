-- =============================================================================
-- View v_phieu_kho_chi_tiet_flat — thêm cột pham_cap
-- Chạy SAU docs/supabase-fp_mh_phieu_kho_chi_tiet_add_pham_cap.sql
-- =============================================================================
...
COMMENT ON VIEW public.v_phieu_kho_chi_tiet_flat IS
  'Chi tiết phiếu kho phẳng (JOIN header + mã HH + phẩm cấp + đơn đặt hàng)';
