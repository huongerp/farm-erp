-- =============================================================================
-- RPC: rpc_farm_de_xuat_mua_hang_stats — tab Thống kê đề xuất mua hàng farm (giảm egress)
-- Chạy trên Supabase SQL Editor
-- =============================================================================

CREATE OR REPLACE FUNCTION public.rpc_farm_de_xuat_mua_hang_stats(
...
COMMENT ON FUNCTION public.rpc_farm_de_xuat_mua_hang_stats IS 'Thống kê đề xuất mua hàng farm — tab Thống kê';

GRANT EXECUTE ON FUNCTION public.rpc_farm_de_xuat_mua_hang_stats(date, date, text[], bigint[], bigint[], bigint[]) TO authenticated;
GRANT EXECUTE ON FUNCTION public.rpc_farm_de_xuat_mua_hang_stats(date, date, text[], bigint[], bigint[], bigint[]) TO anon;
