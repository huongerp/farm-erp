...
const FEATURE_I18N_LOADERS: Record<FeatureI18nKey, () => Promise<{ default: Record<string, string> }>> = {
  ...
  'bao-cao-nhan-cong': () => import('../features/quan-ly-nha-so-che/bao-cao-nhan-cong/locales/vi.json'),
  'bao-cao-so-che': () => import('../features/quan-ly-nha-so-che/bao-cao-so-che/locales/vi.json'),
  'de-xuat-mua-hang': () => import('../features/quan-ly-nha-so-che/de-xuat-mua-hang/locales/vi.json'),
  'du-bao-sl-dong-thung': () => import('../features/quan-ly-nha-so-che/du-bao-sl-dong-thung/locales/vi.json'),
  'hang-hoa-phan-thuoc': () => import('../features/quan-ly-nha-so-che/hang-hoa-phan-thuoc/locales/vi.json'),
  'phieu-kho-phan-thuoc': () => import('../features/quan-ly-nha-so-che/phieu-kho-phan-thuoc/locales/vi.json'),
