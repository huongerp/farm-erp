...
const LoaiKhoaHocToolbar: React.FC<Props> = ({ items = [], onAdd, onDeleteMany, onStatusChangeMany }) => {
  ...
  return (
    <GenericToolbar
      ...
      filterGroups={[{ key: 'status', label: t('common.status'), icon: BookOpen, options: statusOptions, value: filters.status, onChange: (val: string[]) => setFilter('status', val) }]}
      onAdd={onAdd}
      searchPlaceholder={t('thietLapDaoTao.loaiKhoaHoc.searchPlaceholder')}
...
export default LoaiKhoaHocToolbar;
