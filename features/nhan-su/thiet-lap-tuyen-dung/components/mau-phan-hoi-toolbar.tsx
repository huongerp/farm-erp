...
const MauPhanHoiToolbar: React.FC<Props> = ({ items = [], onAdd, onDeleteMany, onStatusChangeMany }) => {
  ...
  return (
    <GenericToolbar
      ...
      filterGroups={[{ key: 'status', label: t('common.status'), icon: Mail, options: statusOptions, value: filters.status, onChange: (val: string[]) => setFilter('status', val) }]}
      onAdd={onAdd}
      searchPlaceholder={t('thietLapTuyenDung.mauPhanHoi.searchPlaceholder')}
...
export default MauPhanHoiToolbar;
