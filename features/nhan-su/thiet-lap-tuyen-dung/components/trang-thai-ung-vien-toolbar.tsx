...
const TrangThaiUngVienToolbar: React.FC<Props> = ({ items = [], onAdd, onDeleteMany, onStatusChangeMany }) => {
  ...
  return (
    <GenericToolbar
      ...
      onAdd={onAdd}
      searchPlaceholder={t('thietLapTuyenDung.trangThaiUngVien.searchPlaceholder')}
...
export default TrangThaiUngVienToolbar;
