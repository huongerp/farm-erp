          ...
          <thead className="sticky top-0 bg-muted/95 z-[1]">
            <tr className="border-b border-border">
              ...
              <th className="text-left px-4 py-2 font-medium text-muted-foreground">
                {t('deXuatMuaHang.stats.itemNameCol')}
              </th>
              <th className="text-right px-4 py-2 font-medium text-muted-foreground">
                {t('deXuatMuaHang.stats.countCol')}
              </th>
            </tr>
          </thead>
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="px-4 py-2.5 border-b border-border bg-muted/20">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-semibold text-foreground">
                {t('deXuatMuaHang.stats.byStatus')}
              </h3>
            </div>
          </div>
        ...
        <TableBlock
          titleKey="deXuatMuaHang.stats.byPlace"
          icon={Warehouse}
          data={byNoiDeXuat}
          emptyMessageKey="deXuatMuaHang.stats.noData"
        />
        <TableBlock
          titleKey="deXuatMuaHang.stats.byRequester"
          icon={User}
          data={byNguoiDeXuat}
          emptyMessageKey="deXuatMuaHang.stats.noData"
        />
        <TableBlock
          titleKey="deXuatMuaHang.stats.byApprover"
          icon={UserCheck}
          data={byNguoiDuyet}
          emptyMessageKey="deXuatMuaHang.stats.noData"
        />
