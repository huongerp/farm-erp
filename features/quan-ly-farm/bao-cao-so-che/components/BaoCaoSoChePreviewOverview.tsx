...
import { getBcscPreviewOverviewRows, type BcscPreviewField } from '../core/bcsc-preview-layout';

interface Props {
  data: FarmBaoCaoSoChe;
}

function OverviewCell({ field }: { field: BcscPreviewField }) {
  return (
...
const BaoCaoSoChePreviewOverview: React.FC<Props> = ({ data }) => {
...
export default BaoCaoSoChePreviewOverview;
