      ...
      <div className="p-1.5">
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="text-2xs text-muted-foreground">{t('thuChi.stats.dataAndMeta')}</p>
          </div>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="text-2xs text-muted-foreground">{t('thuChi.stats.printReport')}</p>
          </div>
        </button>
      </div>
    </div>
  ...
  if (compact) {
    return (
      <div className="flex items-center gap-1.5 shrink-0">
        ...
        {onPrint && (
          <Tooltip content={t('thuChi.stats.printReport')} placement="bottom">
            <Button
              variant="outline"
              size="sm"
              onClick={onPrint}
    ...
    <div className="flex items-center gap-2">
      <div className="relative" ref={ref}>
        ...
        >
          ...
          <span>{isExporting ? t('thuChi.stats.exporting') : t('thuChi.stats.exportReport')}</span>
          {!isExporting && (
