...
const DeXuatMuaHangPage: React.FC = () => {
  ...
  const tabs = useMemo(
    () => [
      { id: 'list', label: t('deXuatMuaHang.tabs.list'), icon: List },
      { id: 'detail', label: t('deXuatMuaHang.tabs.detail'), icon: FileSpreadsheet },
      { id: 'stats', label: t('deXuatMuaHang.tabs.stats'), icon: BarChart3 },
    ],
    [t]
  );
...
export default DeXuatMuaHangPage;
