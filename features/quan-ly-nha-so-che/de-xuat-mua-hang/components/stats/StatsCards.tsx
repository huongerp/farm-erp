...
import type { DeXuatMuaHangStatsSummary } from './useDeXuatMuaHangStats';
...
const StatsCards: React.FC<Props> = ({ summary }) => {
  ...
  const cards = [
    {
      title: t('deXuatMuaHang.stats.total'),
      value: summary.total,
      icon: FileText,
      className: 'bg-primary/10 text-primary border-primary/20',
    },
    {
      title: t('deXuatMuaHang.status.pending'),
      value: summary.pending,
      icon: Clock,
      className: 'bg-amber-500/10 text-amber-700 border-amber-500/20',
    },
    {
      title: t('deXuatMuaHang.status.waiting'),
      value: summary.waiting,
      icon: Hourglass,
      className: 'bg-sky-500/10 text-sky-700 border-sky-500/20',
    },
    {
      title: t('deXuatMuaHang.status.approved'),
      value: summary.approved,
      icon: CheckCircle,
      className: 'bg-emerald-500/10 text-emerald-700 border-emerald-500/20',
    },
    {
      title: t('deXuatMuaHang.status.rejected'),
