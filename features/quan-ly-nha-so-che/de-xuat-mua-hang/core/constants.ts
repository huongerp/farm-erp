/** Giá trị trạng thái đề xuất mua hàng – lưu thẳng text trong DB */
...
/** Phiếu Chờ duyệt quá số ngày này kể từ lúc tạo → hiện badge quá hạn. */
export const THOI_HAN_DUYET_NGAY = 7;
...
export const TRANG_THAI_DE_XUAT_MUA_HANG = [
...
export type TrangThaiDeXuatMuaHang = (typeof TRANG_THAI_DE_XUAT_MUA_HANG)[number];
...
export function filterKeyToTrangThai(key: TrangThaiFilterKey): TrangThaiDeXuatMuaHang {
...
/** i18n key suffix cho trạng thái phiếu (deXuatMuaHang.status.*). */
 ...
 */
export function canBulkApproveDeXuatMuaHang(trangThai: string, canApprove: boolean): boolean {
