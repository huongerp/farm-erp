...
import type { KiemKeKhoPTStatsSummary } from './useKiemKeKhoPTStats';
...
const StatsCards: React.FC<Props> = ({ summary }) => {
  ...
  const cards = [
    {
      title: t('kiemKeKhoPT.stats.total'),
      value: summary.total,
      icon: ClipboardCheck,
      className: 'bg-primary/10 text-primary border-primary/20',
    },
    {
      title: t('kiemKeKhoPT.trangThaiDot.draft'),
      value: summary.draft,
      icon: FileEdit,
      className: 'bg-muted text-muted-foreground border-border',
    },
    {
      title: t('kiemKeKhoPT.trangThaiDot.dang_kiem_ke'),
      value: summary.dangKiemKe,
      icon: Loader2,
      className: 'bg-amber-500/10 text-amber-700 border-amber-500/20',
    },
    {
      title: t('kiemKeKhoPT.trangThaiDot.hoan_thanh'),
