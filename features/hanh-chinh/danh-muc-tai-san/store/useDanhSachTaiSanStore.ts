...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'ten_chi_nhanh', label: i18n.t('danhSachTaiSan.store.chiNhanhCol'), visible: false, minWidth: 160, order: 5 },
  ...
  { id: 'serial', label: i18n.t('danhSachTaiSan.store.serialCol'), visible: false, minWidth: 140, order: 9 },
  ...
  { id: 'ten_nha_cung_cap', label: i18n.t('danhSachTaiSan.store.nhaCungCapCol'), visible: false, minWidth: 160, order: 12 },
  ...
  { id: 'nguyen_gia', label: i18n.t('danhSachTaiSan.store.nguyenGiaCol'), visible: false, minWidth: 120, order: 16 },
  { id: 'tg_cap_nhat', label: i18n.t('danhSachTaiSan.store.updatedCol'), visible: false, minWidth: 140, order: 17 },
];
