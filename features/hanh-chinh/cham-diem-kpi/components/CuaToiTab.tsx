...
import ChamDiemKpiMyToolbar from './ChamDiemKpiMyToolbar';
import ChamDiemKpiMyTable from './ChamDiemKpiMyTable';
...
const CuaToiTab: React.FC = () => {
  ...
  const filterFn = useCallback(
    (item: ChamDiemKpiRecord, term: string, f: typeof filters) => {
      ...
      return matchesSearch && matchesPeriod && matchesDanhGia;
    },
    []
  );
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 min-h-0 flex flex-col rounded-xl border border-border bg-card shadow-sm overflow-hidden">
        <ChamDiemKpiMyToolbar items={myRecords} onAdd={handleAdd} onDeleteMany={handleDeleteMany} />
