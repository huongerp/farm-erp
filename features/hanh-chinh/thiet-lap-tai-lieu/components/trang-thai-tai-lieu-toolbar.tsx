...
interface Props {
  /** Danh sách trạng thái tài liệu. Count filter chip đếm trên list này. */
...
const TrangThaiTaiLieuToolbar: React.FC<Props> = ({ items = [], onAdd, onDeleteMany, onStatusChangeMany }) => {
  ...
  return (
    <GenericToolbar
      ...
      onAdd={onAdd}
      searchPlaceholder={t('thietLapTaiLieu.trangThai.searchPlaceholder')}
...
export default TrangThaiTaiLieuToolbar;
