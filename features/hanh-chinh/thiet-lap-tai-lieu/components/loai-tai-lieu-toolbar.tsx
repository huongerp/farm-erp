...
interface Props {
  /** Danh sách loại tài liệu. Count filter chip đếm trên list này. */
...
const LoaiTaiLieuToolbar: React.FC<Props> = ({ items = [], onAdd, onDeleteMany, onStatusChangeMany }) => {
  ...
  return (
    <GenericToolbar
      ...
      onAdd={onAdd}
      searchPlaceholder={t('thietLapTaiLieu.loai.searchPlaceholder')}
...
export default LoaiTaiLieuToolbar;
