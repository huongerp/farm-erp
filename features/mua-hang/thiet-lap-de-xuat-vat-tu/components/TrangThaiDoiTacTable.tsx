...
interface Props {
  ...
  onRowClick?: (item: TrangThaiDoiTac) => void;
}

const TrangThaiDoiTacTable: React.FC<Props> = ({ data, isLoading, onEdit, onDelete, onRowClick }) => {
  ...
  const renderMobileCard = (item: TrangThaiDoiTac, isSelected: boolean) => (
    <div
      role="button"
      tabIndex={0}
...
export default TrangThaiDoiTacTable;
