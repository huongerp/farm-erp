...
export const useTrangThaiThanhToanDoiTacStore = createGenericStore<TrangThaiThanhToanDoiTacFilters>({ status: [] }, DEFAULT_COLUMNS, 'table-thiet-lap-de-xuat-vat-tu-trang-thai-thanh-toan-doi-tac');
