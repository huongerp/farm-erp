...
export interface TienDoMuaHangFilters {
  status: string[];
}
...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'mau', label: i18n.t('thietLapDeXuatVatTu.tienDoMuaHang.store.mauCol'), visible: true, minWidth: 100, order: 3 },
  { id: 'ghi_chu', label: i18n.t('thietLapDeXuatVatTu.tienDoMuaHang.store.noteCol'), visible: true, minWidth: 180, order: 4 },
  { id: 'trang_thai', label: i18n.t('thietLapDeXuatVatTu.tienDoMuaHang.store.statusCol'), visible: true, minWidth: 110, order: 5 },
