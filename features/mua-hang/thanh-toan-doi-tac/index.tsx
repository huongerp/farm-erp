...
const ThanhToanDoiTacPage: React.FC = () => {
  ...
  const tabs = useMemo(
    () => [
      { id: 'list', label: t('thanhToanDoiTac.tabs.list'), icon: List },
      { id: 'stats', label: t('thanhToanDoiTac.tabs.stats'), icon: BarChart3 },
    ],
    [t]
  );
...
export default ThanhToanDoiTacPage;
