...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'phan_loai', label: i18n.t('hangHoa.store.classificationCol'), visible: true, minWidth: 140, maxWidth: 220, order: 4 },
  ...
  { id: 'mo_ta', label: i18n.t('hangHoa.store.descCol'), visible: true, minWidth: 220, maxWidth: 340, order: 7 },
  { id: 'hinh_anh', label: i18n.t('hangHoa.store.imageCol'), visible: true, minWidth: 80, maxWidth: 100, order: 8 },
  { id: 'tong_dinh_muc', label: i18n.t('hangHoa.store.tongDinhMucCol'), visible: true, minWidth: 120, maxWidth: 160, order: 9 },
  { id: 'so_kho_dinh_muc', label: i18n.t('hangHoa.store.soKhoDinhMucCol'), visible: true, minWidth: 100, maxWidth: 140, order: 10 },
  { id: 'trang_thai', label: i18n.t('hangHoa.store.statusCol'), visible: true, minWidth: 120, maxWidth: 180, order: 11 },
  { id: 'tg_cap_nhat', label: i18n.t('hangHoa.store.updatedCol'), visible: true, minWidth: 160, maxWidth: 220, order: 12 },
];
