...
const seed: HangHoaRow[] = [
  { id: 'hh-1', ma_hang: 'SP-001', ten_hang: 'Giấy A4 70gsm', id_danh_muc: 'dmhh-3', thu_tu: 0, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Ram', ton_toi_thieu: 50, mo_ta: 'Giấy in A4 định lượng 70g/m²', tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-2', ma_hang: 'SP-002', ten_hang: 'Bút bi xanh', id_danh_muc: 'dmhh-4', thu_tu: 1, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Cái', ton_toi_thieu: 100, tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-3', ma_hang: 'SP-003', ten_hang: 'Bút bi đen', id_danh_muc: 'dmhh-4', thu_tu: 2, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Cái', ton_toi_thieu: 80, mo_ta: 'Bút bi ngòi 0.5mm', tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-4', ma_hang: 'SP-004', ten_hang: 'Giấy A4 80gsm', id_danh_muc: 'dmhh-3', thu_tu: 3, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Ram', ton_toi_thieu: 30, tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-5', ma_hang: 'SP-005', ten_hang: 'Bìa màu A4', id_danh_muc: 'dmhh-1', thu_tu: 4, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Tờ', tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-6', ma_hang: 'SP-006', ten_hang: 'Kẹp ghim', id_danh_muc: 'dmhh-1', thu_tu: 5, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Hộp', ton_toi_thieu: 20, mo_ta: 'Kẹp ghim 50 cái/hộp', tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-7', ma_hang: 'SP-007', ten_hang: 'Bột mì', id_danh_muc: 'dmhh-2', thu_tu: 6, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Kg', ton_toi_thieu: 200, tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-8', ma_hang: 'SP-008', ten_hang: 'Đường trắng', id_danh_muc: 'dmhh-2', thu_tu: 7, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Kg', ton_toi_thieu: 150, mo_ta: 'Đường tinh luyện', tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-9', ma_hang: 'SP-009', ten_hang: 'Hàng tồn (ngừng)', id_danh_muc: null, thu_tu: 8, trang_thai: TRANG_THAI_HOAT_DONG.NGUNG_HOAT_DONG, don_vi_tinh: 'Cái', mo_ta: 'Hàng mẫu không còn bán', tg_tao: ts(), tg_cap_nhat: ts() },
  { id: 'hh-10', ma_hang: 'SP-010', ten_hang: 'Tẩy trắng', id_danh_muc: 'dmhh-1', thu_tu: 9, trang_thai: TRANG_THAI_HOAT_DONG.DANG_HOAT_DONG, don_vi_tinh: 'Cái', ton_toi_thieu: 50, tg_tao: ts(), tg_cap_nhat: ts() },
];
