...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'ghi_chu', label: i18n.t('phieuKiemKe.store.notesCol'), visible: true, minWidth: 140, maxWidth: 260, order: 5 },
  { id: 'trang_thai', label: i18n.t('phieuKiemKe.store.statusCol'), visible: true, minWidth: 100, maxWidth: 140, order: 6 },
  { id: 'tg_cap_nhat', label: i18n.t('phieuKiemKe.store.updatedCol'), visible: true, minWidth: 100, maxWidth: 140, order: 7 },
];
