...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'ten_noi_de_xuat', label: i18n.t('phieuDeXuatVatTu.store.noiDeXuatCol'), visible: true, minWidth: 160, maxWidth: 240, order: 3 },
  { id: 'ten_nguoi_de_xuat', label: i18n.t('phieuDeXuatVatTu.store.nguoiDeXuatCol'), visible: true, minWidth: 150, maxWidth: 220, order: 4 },
  { id: 'trang_thai_phieu', label: i18n.t('phieuDeXuatVatTu.store.statusCol'), visible: true, minWidth: 120, maxWidth: 180, order: 5 },
  { id: 'ma_hang', label: i18n.t('phieuDeXuatVatTu.form.itemCode'), visible: true, minWidth: 130, maxWidth: 180, order: 6 },
  { id: 'ten_hang', label: i18n.t('phieuDeXuatVatTu.form.itemName'), visible: true, minWidth: 320, maxWidth: 520, order: 7 },
  { id: 'so_luong', label: i18n.t('phieuDeXuatVatTu.form.quantity'), visible: true, minWidth: 100, maxWidth: 130, order: 8 },
  { id: 'don_vi_tinh', label: i18n.t('phieuDeXuatVatTu.form.unit'), visible: true, minWidth: 90, maxWidth: 120, order: 9 },
  { id: 'ten_tien_do_mh', label: i18n.t('phieuDeXuatVatTu.form.tienDoMh'), visible: true, minWidth: 140, maxWidth: 200, order: 10 },
