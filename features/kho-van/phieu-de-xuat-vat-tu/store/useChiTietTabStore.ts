...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'thong_so', label: i18n.t('phieuDeXuatVatTu.form.specs'), visible: false, minWidth: 100, maxWidth: 180, order: 11 },
  { id: 'ghi_chu', label: i18n.t('phieuDeXuatVatTu.form.note'), visible: true, minWidth: 120, maxWidth: 220, order: 12 },
  { id: 'actions', label: '', visible: true, minWidth: 80, maxWidth: 80, order: 13 },
];

export const useChiTietTabStore = createGenericStore<Record<string, never>>(
  {},
  DEFAULT_COLUMNS
);
