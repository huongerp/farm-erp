...
const PhieuDeXuatVatTuPreviewContent: React.FC<Props> = ({ phieu }) => {
  ...
  return (
    <div className="phieu-de-xuat-preview-content phieu-de-xuat-preview bg-white text-gray-900 font-sans text-[10pt] pt-[15mm] pr-[15mm] pb-[15mm] pl-[20mm] print:p-0 min-h-full flex flex-col">
      {/* Header công ty */}
