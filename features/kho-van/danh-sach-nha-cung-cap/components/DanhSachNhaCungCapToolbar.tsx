...
const DanhSachNhaCungCapToolbar: React.FC<Props> = ({
  data,
  nhomList,
  selectedCount,
  onAdd,
  ...
  const renderFilters = (
    <>
      ...
      <FilterChipMultiSelect
        ...
        placeholder={t('nhaCungCap.form.group')}
        icon={Folder}
  ...
  return (
    <GenericToolbar
      ...
      onAdd={onAdd}
      showBack
      searchPlaceholder={t('nhaCungCap.searchPlaceholder')}
...
export default DanhSachNhaCungCapToolbar;
