...
interface EmployeeStatsProps {
  ...
  onDrillDownStatus?: (status: number) => void;
}
...
const EmployeeStats: React.FC<EmployeeStatsProps> = ({
  ...
  const statsFilterGroups = useMemo(
    ...
    [departmentOptions, statusOptions, filterDept, filterStatus, t]
  );
  ...
  const handleExportReport = useCallback(
    ...
    [userRole, filterDept, filterStatus, dateRange.label, departments, kpis, deptSummary, t]
  );
  ...
  const renderFilters = (
    <>
      ...
      <MultiSelect
        ...
        icon={Tag}
        placeholder={t('employee.stats.status')}
        className="w-[140px]"
      />
    </>
  );
        ...
        <div className="p-3 sm:p-4 pb-4 space-y-3">
          {isEmpty ? (
            ...
            <>
              ...
              <div className="flex items-center gap-1.5 text-2xs text-muted-foreground px-0.5 flex-wrap">
                <span>
