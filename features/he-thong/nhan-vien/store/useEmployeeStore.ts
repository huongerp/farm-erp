...
const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'ten_phong_ban', label: i18n.t('employee.store.departmentCol'), visible: true, minWidth: 130, order: 2 },
  { id: 'ten_chuc_vu', label: i18n.t('employee.store.positionDeptCol'), visible: true, minWidth: 160, order: 3 },
  { id: 'email', label: i18n.t('employee.store.emailCol'), visible: true, minWidth: 180, order: 4 },
  { id: 'lien_he', label: i18n.t('employee.store.phoneCol'), visible: true, minWidth: 120, order: 5 },
  { id: 'ngay_vao_lam', label: i18n.t('employee.store.hireDateCol'), visible: true, minWidth: 100, maxWidth: 140, order: 6 },
  { id: 'gioi_tinh', label: i18n.t('employee.store.genderCol'), visible: true, minWidth: 80, maxWidth: 110, order: 7 },
  { id: 'trang_thai', label: i18n.t('employee.store.statusCol'), visible: true, minWidth: 110, maxWidth: 160, order: 8 },
  // ── Ẩn mặc định – chọn trong column chooser ──
  { id: 'ngay_sinh', label: i18n.t('employee.store.birthDateCol'), visible: false, minWidth: 100, maxWidth: 140, order: 9 },
