...
import { Briefcase, Power, Building2, Layers, Calendar, Clock, FileText } from 'lucide-react';
...
const PositionDetail: React.FC<Props> = ({ data, onClose, onEdit, onDelete, onStatusChange, canUpdate = true, canDelete = true }) => {
